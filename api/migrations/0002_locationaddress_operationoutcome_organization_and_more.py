...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "encounter",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="api.encounter"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="specimen",
            field=models.ManyToManyField(
                help_text="Who is responsible for the observation", to="api.specimen"
            ),
        ),
    ]
